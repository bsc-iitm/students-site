      ...
      {list.map((member) => {
        return (
          <div className="card m-1 border-0" style={{minWidth: "20%", width: "20%"}} key={member.house+"-"+role}>
            <img src={member.imgURL || "https://149362210.v2.pressablecdn.com/wp-content/uploads/2018/04/img-placeholder-rectangle.jpg"} alt={member.name} style={{borderRadius: "50%", width: "150px", height: "150px"}} className="card-img-top mx-auto" />
