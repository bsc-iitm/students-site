...
const EventsPage = () => {
  ...
  return (
    <Layout>
      ...
      <div class="track wf-section">
        <div data-w-id="99921bf1-cf11-7097-7706-8582b7ed6e30" class="div-block-23">
          <img src="https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49a099689f7060f0921f1_WhatsApp%20Image%202023-02-01%20at%2021.25.52.jpg" loading="lazy" sizes="(max-width: 767px) 100vw, 600px" srcset="https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49a099689f7060f0921f1_WhatsApp%20Image%202023-02-01%20at%2021.25.52-p-500.jpg 500w, https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49a099689f7060f0921f1_WhatsApp%20Image%202023-02-01%20at%2021.25.52.jpg 720w" alt="diplomacia" class="image-11" />
          <img src="https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49add8b5a9c2dc449fcc9_WhatsApp%20Image%202023-01-23%20at%2020.05.57.jpg" loading="lazy" sizes="(max-width: 479px) 100vw, 282.5px" srcset="https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49add8b5a9c2dc449fcc9_WhatsApp%20Image%202023-01-23%20at%2020.05.57-p-500.jpg 500w, https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49add8b5a9c2dc449fcc9_WhatsApp%20Image%202023-01-23%20at%2020.05.57-p-800.jpg 800w, https://uploads-ssl.webflow.com/63a4093ca918637551d8e43e/63e49add8b5a9c2dc449fcc9_WhatsApp%20Image%202023-01-23%20at%2020.05.57.jpg 904w" alt="republica" class="image-12" />
      ...
      <div className="section-13 wf-section">
        <div class="container-22 w-container">
          <div class="wf-section">
            <h1 class="sub-heading">Oncampus Gatherings</h1>
          </div>
          <div class="hero-wrapper-5 wrapper-reverse">
            <div data-w-id="353b6c83-3d32-9f8a-ee5f-2d75418e9b35" class="hero-split-5">
              <ScrollSlideRight>
                <h1 class="sub-heading">Paradox</h1>
                <p class="paragraph-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tincidunt sagittis eros. Quisque quis euismod lorem. Etiam sodales ac felis id interdum.</p>
                <a href="#" class="f-button-secondary w-button">Learn More</a>
              </ScrollSlideRight>
            </div>
            <div class="hero-split-5">
              <ScrollSlideLeft>
                <img src="https://uploads-ssl.webflow.com/62434fa732124a0fb112aab4/62434fa732124a2a3312aae1_placeholder%203.svg" loading="lazy" data-w-id="353b6c83-3d32-9f8a-ee5f-2d75418e9b3d" alt="" class="shadow-two-5" />
              </ScrollSlideLeft>
            </div>
          </div>
          <div class="hero-wrapper-5">
            <div class="hero-split-5">
              <ScrollSlideRight>
                <img src="https://uploads-ssl.webflow.com/62434fa732124a0fb112aab4/62434fa732124a28a812aad9_placeholder%202.svg" loading="lazy" data-w-id="ea2f6e45-1bf7-225a-4b77-aa86c5300bc4" alt="" class="shadow-two-5" />
                </ScrollSlideRight>
            </div>
            <div data-w-id="53f24398-73d1-76e4-abbc-d8e1470b2f14" class="hero-split-5">
              <ScrollSlideLeft>
                <h1 class="sub-heading">Margazhi in Paradox</h1>
                <p class="paragraph-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tincidunt sagittis eros. Quisque quis euismod lorem. Etiam sodales ac felis id interdum.</p>
                <a href="#" class="f-button-secondary w-button">Learn More</a>
              </ScrollSlideLeft>
            </div>
